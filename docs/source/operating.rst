[lastattempt2-a89c] Operating Details
====================================

Generated On: 2024-11-09 04:45:12 UTC
...
.. important::
   ...
   **not be valid if your [lastattempt2-a89c] container is NOT running**.

.. tip::
   You must have your [lastattempt2-a89c] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46809  \-\-env VIPERVIZPORT=60301  \-\-env GITUSERNAME='Hooluwole'  \-\-env DOCKERUSERNAME='hooluwole70'  \-\-env MQTTUSERNAME='hooluwole70'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:60301/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:60301/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 39893:39893 -p 53895:53895 -p 52887:52887 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=lastattempt2-a89c \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c \-\-env GITUSERNAME=Hooluwole  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi \-\-env SOLUTIONEXTERNALPORT=39893  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=53895  \-\-env SOLUTIONVIPERVIZPORT=52887 \-\-env DOCKERUSERNAME='hooluwole70' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=46809 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=60301 \-\-env MQTTUSERNAME='hooluwole70' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  hooluwole70/lastattempt2-a89c-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - hooluwole70/lastattempt2-a89c-amd64
...
[lastattempt2-a89c] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Hooluwole/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/lastattempt2-a89c
...
.. important::
   solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=39893, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38121, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45245, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38725, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33791, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=35275, HPDEHOST=127.0.1.1, HPDEPORT=42121, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43263

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-943-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, python-preprocess-904-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, python-ai-6260-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
