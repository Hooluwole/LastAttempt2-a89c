...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Hooluwole/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39863  \-\-env VIPERVIZPORT=54881  \-\-env GITUSERNAME='Hooluwole'  \-\-env DOCKERUSERNAME='hooluwole70'  \-\-env MQTTUSERNAME='hooluwole70'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:54881/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54881/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=40457, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40823, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=42513, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33739, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44037, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42081, HPDEHOST=127.0.1.1, HPDEPORT=45039, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=34403

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-605-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, python-preprocess-572-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, python-ai-4517-lastattempt2-a89c,solution_preprocessing_ai_mqtt_dag-lastattempt2-a89c, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
